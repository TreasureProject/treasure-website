              ...
              <div className="col-span-6 space-y-5 text-night-400 text-sm sm:text-justify sm:text-base">
                ...
                <div>
                  ...
                  <p>
                    ...
                    provided to us voluntarily by you, collected automatically
                    by us from you, or received by us from a third party source.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-5 list-disc pl-10">
                    ...
                    <li>
                      ...
                      related to the transaction, transaction price information,
                  ...
                  <p className="mt-5">
                    ...
                    us that we do not request, and, in such instances, we have
                    no control over what categories of personal information such
                    disclosure may include. Any additional information provided
                    by you to us is provided at your own risk.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-5">
                    Treasure also collects certain personal information about
                    you automatically when you use the Site. This information
                    includes information about your computer hardware, software,
                    and network when you access or use the Site. This
                    information may include: your IP address, browser type,
                    domain names, access times, geographic location, referring
                    website addresses and other technical information such as
                    protocol status and substatus, bytes sent and received, and
                    server information. We may also collect information about
                    how you interact with the Site. This information is used by
                    us for our business purposes, for the operation and
                    improvement of the Site, for technical troubleshooting, to
                    maintain quality of the Site and to provide general
                ...
                <div>
                  ...
                  <p className="mt-5">
                    ...
                    certain transactions that you engage in on the blockchain
                    will be publicly available. We may collect certain
                  ...
                  <p>
                    ...
                    tracking technologies on our Site, however, third-party
                    sites that may be linked through our Site may use cookies or
                    other tracking technologies. If we decide to use cookies or
                    other tracking technologies other than necessary or
                    essential cookies, we will inform you by updating this
                    Privacy Policy.
                  </p>
                  ...
                  <p>
                    We may use the information we collect for any of the
                    following purposes:
                  </p>
                  <ul className="mt-2 list-disc pl-10">
                    <li>
                      to provide the Site (including the marketplace for NFTs)
                      to you and to improve the Site and user experience;
                    </li>
                  ...
                  <ul className="mt-2 list-disc pl-10">
                    <li>
                      ...
                      providers to perform the functions for which we engage
                      them. For example, we may use third parties to host the
                      Site or assist us in providing functionality of the Site,
                    ...
                    <li>
                      ...
                      as needed to enforce our rights, protect our property or
                      ...
                      regulation, binding order of a data protection agency,
                      legal process, governmental request or any other legal or
                      regulatory process. We may also share personal information
                      as required to pursue available remedies or limit damages
                      we may sustain.
                    </li>
                    <li>
                      <span className="font-bold text-night-100">
                      ...
                      parties not controlled by Treasure. Transactions recorded
                      on the blockchain permanently recorded across a wide
                      networks of computer systems and is generally incapable of
                      deletion. Many blockchains are open to forensic analysis
                      which can lead to deanonymization and the unintentional
                      revelation of personal information, especially when
                    ...
                    <li>
                      ...
                      sale or any other type of acquisition, business
                      combination of all or any portion of our business or
                      assets, change of control, or a transfer of all or a
                      portion of our business or assets to another third party
                      (including in the case of any bankruptcy proceeding).
                    </li>
                  </ul>
                  <p className="mt-5">
                  ...
                  <p>
                    Treasure uses reasonable security measures designed to
                    prevent unauthorized intrusion to the Site and the
                    alteration, acquisition or misuse of personal information
                    that Treasure directly controls, however, we will not be
                    responsible for loss, corruption or unauthorized acquisition
                    or misuse of personal information that you provide through
                    the Site that is stored by us, or for any damages resulting
                    from such loss, corruption or unauthorized acquisition or
                    misuse. It is your responsibility to protect the security of
                    your Digital Wallet Information. We will retain your
                  ...
                  <p>
                    Our Site may contain links to third party websites. Any
                    access to and use of such third party websites is not
                    governed by this Privacy Policy, but is instead governed by
                    the privacy policies of those third party websites, and we
                    are not responsible for the information practices of such
                  ...
                  <p>
                    Any changes to our Privacy Policy will be posted to this
                    page so users are always aware of the information we collect
                    and how we use it. Accordingly, please refer back to this
                    Privacy Policy frequently as it may change.
                  </p>
                </div>
              </div>
            </div>
