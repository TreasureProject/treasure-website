              ...
              <div className="col-span-6 space-y-5 text-sm text-night-400 sm:text-justify sm:text-base">
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    DIGITAL WALLET, OR BY OTHERWISE USING THE PLATFORM, YOU
                    ACCEPT AND AGREE TO BE BOUND BY THESE TERMS EFFECTIVE AS OF
                    THE DATE OF SUCH ACTION. YOU EXPRESSLY ACKNOWLEDGE AND
                    REPRESENT THAT YOU HAVE CAREFULLY REVIEWED THESE TERMS AND
                    FULLY UNDERSTAND THE RISKS, COSTS AND BENEFITS RELATED TO
                    TRANSACTIONS MADE USING THE PLATFORM. IF YOU DO NOT AGREE
                    WITH THESE TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM
                    USING THE PLATFORM.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    CLAIM AGAINST TREASURE. IF YOU DO NOT WISH TO WAIVE RIGHTS
                    AND SUBMIT TO ARBITRATION, YOU MUST CONTACT US WITHIN THIRTY
                    (30) DAYS OF FIRST USING THE PLATFORM AND INFORM US THAT YOU
                    OPT-OUT OF SUCH CLASS ACTION WAIVER AND/OR ARBITRATION
                    RIGHT.
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    changes or modifications to these Terms at any time and for
                    any reason. All changes are effective immediately when we
                    post them. It is your responsibility to regularly check
                    these Terms to stay informed of updates, as they are
                    binding. We will indicate that these Terms have been updated
                    by updating the “Last Revised” date at the top of these
                    Terms. Your continued use of the Site following the posting
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    The Platform at its core is an ecosystem for game
                    development, content creation and interactive game play
                    using blockchain technology and Digital Assets (as defined
                    below). Games offered on the Platform and software built by
                    third-party developers on the Platform, may be subject to
                    additional terms. Please review all applicable terms with
                    respect to any game or Digital Asset (as defined below)
                    which will apply in addition to these Terms. For more
                  ...
                  <p>
                    ...
                    publicly visible whenever you engage in any transaction on
                    the Platform. We shall not be liable for the acts or
                    omissions of any such blockchain or associated third
                    parties, nor shall we be liable for any damage that you may
                    suffer as a result of your transactions or any other
                    interaction with any such blockchain or associated third
                    parties.
                  </p>
                  ...
                  <p>
                    ...
                    owned NFTs, distribute, publicly perform, or publicly
                    display any Treasure Materials (as defined below), (b)
                    modify or otherwise make any derivative uses of the
                    Platform, or any portion thereof, (c) download (other than
                    page caching) any portion of the Platform or Treasure
                    Materials, except as expressly permitted by us, or (d) use
                    the Platform or Treasure Materials other than for their
                    intended purposes.
                  </p>
                  <p>
                    Treasure shall have sole and complete control over, and
                    reserves the right at any time to make any changes to, the
                    configuration, appearance, content functionality, and scope
                    of the Platform, including any Treasure Materials.
                    Notwithstanding anything contained in these Terms, we
                    reserve the right, without notice and in our sole
                    discretion, to impose limitations on, suspend, and/or
                    terminate your right to access or use the Platform, in whole
                    or in part, at any time and for any or no reason, and you
                    acknowledge and agree that we shall have no liability or
                    obligation to you in such event and that you shall not be
                  ...
                  <p>
                    ...
                    and on behalf of your licensors, all necessary rights,
                    consents, and permissions to provide User Generated Content
                    to the Platform and that the User Generated Content does not
                    and will not infringe upon or violate intellectual property
                    rights, publicity rights, privacy rights or any other rights
                  ...
                  <p>
                    ...
                    below). You have the sole responsibility to (a) establish,
                    and maintain, in fully operational, secure and valid status,
                    access to your Digital Wallet, and (b) maintain, in your
                    fully secure possession, the credentials for accessing your
                    Digital Wallet and the private key for your Digital Wallet.
                    In the event of any loss, hack or theft of any Digital Asset
                    from your Digital Wallet, including any cryptocurrency, any
                    NFT or other non-fungible token, you acknowledge and agree
                    that you shall have no right(s), claim(s) or causes of
                    action in any way whatsoever against Treasure for such loss,
                    hack or theft, including with respect to any such Digital
                    Asset.
                  </p>
                  ...
                  <ol className="mt-2 list-[lower-alpha] pl-10">
                    ...
                    <li>
                      Infringe upon or violate intellectual property rights or
                      any other rights of anyone else (including Treasure);
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      obtain source code or underlying ideas or information of
                      or relating to the Platform we provide;
                    </li>
                    <li>
                      Attempt to gain unauthorized access to, interfere with,
                      damage, or disrupt any parts of the Platform, the server
                      on which any part of the Platform requires, or any other
                    ...
                    <li>
                      Use the Platform to engage in price manipulation, fraud,
                      or other deceptive, misleading, or manipulative activity;
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    Service, the Platform may similarly experience a disruption,
                    and we shall not be responsible or liable for any such
                    disruption.
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    respective buyer and seller of the applicable NFT, and
                    subject to the NFT Terms (as defined below) that are related
                    to such NFT. “NFT Terms” shall mean the applicable terms
                    related to a sale of an NFT, including the list price of the
                    NFT for sale as determined by the user selling the NFT, the
                  ...
                  <p>
                    ...
                    including, without limitation any taxes that may become
                    payable as the result of your ownership, transfer, purchase,
                    or sale, of any NFTs.
                  </p>
                  ...
                  <p>
                    ...
                    addition, certain blockchain networks require the payment of
                    a transaction fees (also referred to as “gas fees”) for
                    every transaction that occurs on such blockchain network.
                    You are responsible for the payment of gas fees. The value
                    of the gas fees may change, often unpredictably, and is
                    entirely outside of the control of Treasure. You acknowledge
                    that under no circumstances will a contract, agreement,
                    sale, or other transaction on the Platform be invalidated,
                    revocable, retractable, or otherwise unenforceable on the
                    basis that the transaction fee for the given transaction was
                    unknown, too high, or otherwise unacceptable to you. You
                    also acknowledge and agree that gas fees are non-refundable
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    copyright, trade dress, trademark, patent laws,
                    international conventions, other relevant intellectual
                    property and proprietary rights, and applicable laws. Your
                    use of the Platform or any purchase of any NFT by you does
                    not grant you ownership of any other rights with respect to
                    the Treasure Materials or the Platform, whether expressly,
                    by implication, estoppel, reliance or otherwise, all of
                  ...
                  <p>
                    You or your licensors shall own all right, title and
                    interest in and to the User Generated Content you create.
                    Any User Generated Content will be considered
                    non-confidential and non-proprietary and you agree not to
                    post any User Generated Content to the Platform that you or
                    others may consider to be confidential or proprietary. By
                    submitting User Generated Content via the Platform, you
                    hereby grant to Treasure an unconditional, irrevocable,
                    non-exclusive, royalty-free, perpetual, fully transferable,
                    assignable, and sublicensable worldwide license to use,
                    reproduce, display, distribute, modify, and create
                    derivative works of the User Generated Content for any
                    lawful purpose.
                  </p>
                  ...
                  <p>
                    ...
                    non-confidential. You hereby assign to us on your behalf,
                    ...
                    intellectual property rights contained in the Feedback, for
                    any purpose whatsoever, although we are not required to use
                    any Feedback.
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    (“Privacy Policy”) describes the ways we collect, use,
                    store, and share your personal information collected through
                    the use of the Platform, and is hereby incorporated by this
                    reference into these Terms. You agree to the collection,
                    use, storage, and disclosure of your data in accordance with
                    our Privacy Policy.
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    TRANSACTION, YOU RELEASE US FROM CLAIMS, DEMANDS, AND
                    DAMAGES OF EVERY KIND AND NATURE, KNOWN AND UNKNOWN, ARISING
                    OUT OF OR IN ANY WAY CONNECTED WITH SUCH DISPUTES. IN
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    be liable or responsible to you for any inconvenience,
                    losses or any other damages as a result of Downtime,
                    including your inability to make a purchase of an NFT that
                    is no longer available following the Downtime. You hereby
                    waive any claim against Treasure arising out of or in
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    CONDITIONS, AND REPRESENTATIONS OF ANY KIND, WHETHER
                    EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING THOSE
                    RELATED TO TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR
                    PURPOSE, NON-INFRINGEMENT, AND THOSE ARISING OUT OF COURSE
                    OF DEALING OR USAGE OF TRADE. TREASURE MAKES NO
                    REPRESENTATION OR WARRANTY: (A) THAT THE PLATFORM OR ANY
                    CONTENT OR INFORMATION DISPLAYED ON OR MADE AVAILABLE ON OR
                    THROUGH THE PLATFORM, INCLUDING ANY PLATFORM CONTENT,
                    DIGITAL ASSETS (INCLUDING ANY NFTS AND REFERENCED CONTENT),
                    OR ANY OTHER CONTENT OR INFORMATION DISPLAYED ON OR THROUGH
                    THE PLATFORM: (i) WILL MEET YOUR REQUIREMENTS; (ii) WILL BE
                    AVAILABLE ON AN UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE
                    BASIS; (iii) ARE OR WILL BE FREE OF MALICIOUS CODE; OR (iv)
                    WILL BE ACCURATE, COMPLETE, RELIABLE, CURRENT, LEGAL, OR
                    SAFE; (B) AS TO THE VALUE OR TITLE OF ANY DIGITAL ASSETS OR
                    ANY OTHER CONTENT OR INFORMATION DISPLAYED ON OR THROUGH THE
                    PLATFORM; OR (C) IN RELATION TO THE CONTENT OF ANY
                    THIRD-PARTY SERVICES LINKED TO OR INTEGRATED WITH THE
                    PLATFORM.
                  </p>
                  <p>
                    ...
                    OR ANY UNDERLYING OR ASSOCIATED CONTENT OR ITEMS. ANY SALE
                    OR TRANSFER OF AN NFT MADE ON THE PLATFORM WILL BE FINAL AND
                    MAY NOT BE REVERSABLE.
                  </p>
                  <p>
                    TREASURE IS NOT RESPONSIBLE OR LIABLE FOR ANY SUSTAINED
                    LOSSES OR INJURY CAUSED BY ANY EXPLOITATION, VULNERABILITY
                    OR OTHER FORM OF FAILURE OR MISFUNCTIONING OF SOFTWARE
                    INCLUDING APPLICABLE DIGITAL WALLETS AND SMART CONTRACTS),
                    APPLICABLE BLOCKCHAINS OR ANY FEATURES BUILT INTO AN
                    APPLICABLE NFT, INCLUDING ANY ISSUES WITH THE BLOCKCHAIN
                    SUPPORTING THE NFTS, FORKS, TECHNICAL NODE ISSUES OR ANY
                    OTHER ISSUES THAT MAY RESULT IN LOSSES OR INJURY TO A USER.
                  </p>
                  <p>
                    IN ADDITION, WE SHALL NOT BE RESPONSIBLE OR LIABLE TO YOU
                    FOR ANY LOSSES YOU INCUR AS THE RESULT OF (A) USER ERROR,
                    SUCH AS FORGOTTEN PASSWORDS OR INCORRECTLY CONSTRUED SMART
                    CONTRACTS OR OTHER TRANSACTIONS; (B) SERVER FAILURE OR DATA
                    LOSS; (C) CORRUPTED WALLET FILES; OR (D) UNAUTHORIZED ACCESS
                    OR ACTIVITIES BY THIRD PARTIES, INCLUDING, BUT NOT LIMITED
                    TO THE USE OF VIRUSES, PHISHING, BRUTE FORCING, OR OTHER
                    MEANS OF ATTACK AGAINST THE PLATFORM, APPLICABLE BLOCKCHAIN,
                    OR A DIGITAL WALLET.
                  </p>
                  ...
                  <p>
                    TREASURE, AND ITS PARENT AND ITS AFFILIATES, AND ITS AND
                    ...
                    CONTRACT, TORT, OR ANY OTHER TYPES OF DAMAGES, INCLUDING
                    DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL,
                    PUNITIVE, OR EXEMPLARY DAMAGES, UNDER THESE TERMS OR ARISING
                  ...
                  <p>
                    ...
                    ABOVE DISCLAIMERS OR LIMITATION OF LIABILITY TO APPLY TO
                    YOU, SUCH DISCLAIMERS AND/OR LIMITATIONS WILL APPLY TO YOU
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    You hereby acknowledge and assume the risk of using and
                    making purchases through the Platform and take full
                    responsibility and liability for the outcome of actions
                    initiated. Without limiting any risks that exist, you
                    acknowledge the following risks related to blockchain
                  ...
                  <ul className="mt-5 list-disc pl-10">
                    ...
                    <li>
                      ...
                      non-fungible tokens, cryptocurrency, and other
                      crypto-based items is uncertain, and new regulations or
                      policies may materially adversely affect the development
                    ...
                    <li>
                      ...
                      associated with content created by third parties through
                      peer-to-peer transactions, including, but not limited to,
                      the risk that items are vulnerable to metadata decay, bugs
                      in smart contracts, and items that may become
                      untransferable. You represent and warrant that you have
                      done sufficient research before making any decisions to
                      sell, obtain, transfer, or otherwise interact with any
                      non-fungible tokens.
                    </li>
                    <li>
                      <span className="font-bold text-night-100">
                      ...
                      other third party products that you may be interacting
                      with, and we do not control third-party smart contracts
                      and protocols that may be integral to your ability to
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    and (2) you or Treasure may seek equitable relief in court
                  ...
                  <p>
                    ...
                    alternative arbitral forum. Any judgment on the award
                  ...
                  <p>
                    ...
                    is void or voidable. The arbitrator shall have the authority
                  ...
                  <p>
                    YOU AND TREASURE HEREBY WAIVE ANY CONSTITUTIONAL AND
                    STATUTORY RIGHTS TO SUE IN COURT AND HAVE A TRIAL IN FRONT
                    OF A JUDGE OR A JURY, EXCEPT AS SPECIFIED IN NUMBER 1 ABOVE.
                  </p>
                  <p>
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    sole responsibility to ensure that your use of the Platform
                    is not prohibited, restricted, curtailed, hindered, impaired
                    or otherwise adversely affected in any way by any applicable
                    law in your country of residence or domicile. In addition,
                    you are not authorized to use the Platform if you are:
                  </p>
                  <ol className="mt-5 list-decimal pl-10">
                    <li>
                      a citizen, domiciled in, resident of, or physically
                      present / located in Iran, North Korea, Cuba, Syria,
                    ...
                    <li>
                      a corporate body: (i) which is incorporated in, or
                      operates out of, an Excluded Jurisdiction, or (ii) which
                      is under the control of one or more individuals who is/are
                      citizens of, domiciled in, residents of, or physically
                    ...
                    <li>
                      ...
                      imposed by the United Nations Security Council accessible
                      at{" "}
                      <a
                      ...
                      ; or (ii) included in the United Nations Lists (UN Lists)
                      or within the ambit of regulations relating to or
                    ...
                    <li>
                      an individual or corporate body who is otherwise
                      prohibited or ineligible in any way, whether in full or in
                      part, under any law applicable to such individual or
                      corporate body from participating in any part of the
                      Platform.
                    </li>
                  </ol>
                  <p>
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    third-party, and (d) your negligence or willful misconduct.
                    If we assume the defense of such a matter, you shall
                ...
                <div className="space-y-5">
                  ...
                  <p>
                    ...
                    forth in writing and signed by us. No failure to exercise,
                    or delay in exercising, any right, remedy, power or
                    privilege arising from these Terms operates, or may be
                    construed, as a waiver thereof. No single or partial
                  ...
                  <p>
                    ...
                    assets or equity, or by operation of law. You shall not
                    ...
                    of this Section is null and void. No assignment or
                    delegation relieves either party of any of its obligations
                    under these Terms.
                  </p>
                  ...
                  <p>
                    ...
                    laws of the British Virgin Islands, without giving effect to
                    any conflict of laws rules or provisions. You consent and
                    submit to the personal jurisdiction of the courts in the
