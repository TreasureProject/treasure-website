...
import { parseDocument } from "~/utils/parse.server";
...
export const loader = async ({ request, params }: LoaderArgs) => {
  ...
  const ogImageUrl =
    `${requestUrl.origin}/action/og?slug=${slug}` +
  ...
  return (
    <main className="container mt-2 lg:mt-12 lg:grid lg:grid-cols-8 lg:gap-10">
      <div className="col-span-6">
        ...
        <article
          id="content"
          className="prose prose-sm prose-night mt-12 max-w-none dark:prose-invert sm:prose-base lg:prose-lg prose-blockquote:border-l-ruby-400 prose-pre:relative prose-pre:bg-night-800 prose-pre:after:absolute prose-pre:after:top-0 prose-pre:after:right-0 prose-pre:after:rounded-bl-md prose-pre:after:bg-night-900 prose-pre:after:px-2 prose-pre:after:py-1 prose-pre:after:text-xs prose-pre:after:content-[attr(data-lang)] prose-li:marker:text-ruby-800 prose-img:rounded-lg prose-img:ring-2 prose-img:ring-night-900/10 hover:prose-a:text-ruby-900 prose-pre:dark:bg-night-800/50 prose-pre:after:dark:bg-night-800 prose-img:dark:ring-night-500/10"
        ...
        <div className="mt-16 rounded-2xl border border-honey-400 bg-honey-25 p-8 dark:border-night-800 dark:bg-[#131D2E] sm:mt-28 sm:p-10">
          <div className="flex flex-col items-center justify-between space-y-4 sm:flex-row sm:space-y-0">
            ...
            <a
              ...
              className="rounded-md bg-ruby-900 py-4 px-5 text-sm font-bold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ruby-600 hover:bg-ruby-700 sm:py-4 sm:px-7 sm:text-base"
            >
              Subscribe
            </a>
          </div>
