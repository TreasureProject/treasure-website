...
export default function About() {
  ...
  return (
    <Layout>
      <div className="relative bg-silver py-16 pt-32 sm:py-24 sm:pt-48">
        <div className="mx-auto max-w-md px-8 text-center sm:max-w-5xl sm:px-6 lg:px-12">
          <Badge
            name="About Treasure"
            bgColor="bg-night-400"
        ...
        <div className="mx-auto mt-16 max-w-sm px-4 text-center sm:max-w-4xl sm:px-8 lg:px-20">
          <div className="rounded-2xl border-2 border-night-400 px-4 py-20 sm:p-20">
            <p className="font-bold text-base text-silver-400 sm:text-2xl">
            ...
            <div className="mx-auto mt-10 block w-full rounded-tag bg-night-400 px-2.5 py-3 sm:w-max sm:py-1.5">
          ...
          <div className="grid auto-rows-[15rem] grid-cols-1 gap-10 sm:auto-rows-[20rem] xl:grid-cols-3">
            <div className="relative flex flex-col justify-between overflow-hidden rounded-2.5xl border-2 border-honey-300 bg-[linear-gradient(to_right,#101827ed_30%,#10182790),url('/img/bg-hero.jpg')] bg-center bg-cover bg-honey-50 bg-no-repeat p-10">
              <div className="space-y-2.5">
                ...
                <p className="text-cream text-sm sm:text-base lg:text-lg">
            ...
            >
              <div className="flex space-x-6">
                {socials.map((social) => (
                  <a
                    key={social.name}
                    className="text-night-400 hover:text-silver"
                    href={social.href}
                    target="_blank"
