import SPLASHART_IMAGE from "@/img/new-landing/Treasure_new_splash_final_extended_canvas_LR.webp";
  ...
  return (
    <div className="relative h-screen max-h-[1024px] w-screen">
      <div className="container relative z-30 flex h-full flex-col justify-between pt-32 pb-12 sm:pt-48 sm:pb-20">
        <h1 className="max-w-[240px] font-bold text-5xl text-cream leading-[105%] sm:max-w-lg sm:text-8xl">
          The magic of play.
        </h1>
      ...
      <LandingCutOff className="-bottom-[1px] absolute right-0 z-20 w-[80px] text-honey-100 sm:w-[128px]" />
