...
export const Arrow = ({
  ...
  return (
    <button
      className={twMerge(
        "absolute top-1/2 inline-block -translate-y-1/2 rounded-lg border-2 border-night-900 bg-night-800 p-2 shadow-lg shadow-night-900/50 transition-colors hover:bg-night-800/95 disabled:opacity-50 sm:rounded-2xl sm:p-4",
        dir === "left"
