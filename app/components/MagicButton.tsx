...
export const MagicButton = () => {
  ...
  return (
    <div className="relative z-10 w-min">
      <motion.button
        initial={{
          opacity: 0.85,
        }}
      ...
      />
      <span className="absolute top-1/2 left-1/2 -z-10 inline-block h-[400%] w-[200%] -translate-x-1/2 -translate-y-1/2 [-webkit-mask-image:radial-gradient(80%_50%_at_center,white,transparent_65%)]">
