        ...
        {!props.hideExternalIcon && (
          <ArrowTopRightOnSquareIcon
            className={twMerge(
              ...
              props.type === "primary" &&
                "[&>path]:stroke-white group-hover:[&>path]:stroke-ruby-1000"
            )}
            aria-hidden="true"
          />
        )}
